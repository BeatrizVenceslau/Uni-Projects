...
create table analise
    ...
    especialidade varchar(80), --alterado na quarta entrega para n ter null
    num_cedula int,
    num_doente int,
    data date,
...
create table prescricao_venda
    ...
    data date not null,
    substancia varchar(80) not null,
    num_venda int not null unique,    -- alterado entrega 4
...
--inserir no populate anterior
/*insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (7, 'Sangue', 0, 3, '01-01-2020', '13-01-2020', 'glicemia', 45, 'Clinica Teixeira');
insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (8, 'Oncologia', 2, 0, '04-11-2020', '15-11-2020', 'glicemia', 60, 'Clinica Teixeira');
insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (9,'Pediatria', 0, 6, NULL, '17-11-2020', 'glicemia', 60, 'Clinica Teixeira');
insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (10, 'Sangue', 3, 3, '03-01-2019', '13-01-2019', 'glicemia', 45, 'Clinica Teixeira');
insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (11, 'Pediatria', 3, 6, '04-01-2019', '15-01-2019', 'glicemia', 60, 'Hospital Venceslau');
insert into analise(num_analise, especialidade, num_cedula, num_doente, data, data_registo, nome, quant, inst)
values (12, 'Oncologia', 4, 5, '07-01-2019', '20-01-2019', 'glicemia', 100, 'Clinica Teixeira');*/
